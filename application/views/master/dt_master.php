    ...
    <div>
      <div class="row">
        ...
        <div class="col-md-4 col-12">
          <select id="filter_data" onchange="filter()" class="form-control">
...
function filter(){
  var select_value = $('#filter_data').val();
  var url = "<?php echo $grid['grid_dt_url']?>?dep_id="+select_value;
    console.log(select_value);
  <?php echo $grid['grid_tbl_name']; ?>_tbl.api().ajax.url( url ).load();
}
</script>
</div>