<div class="modal fade add_department_modal" id="add_department_modal" tabindex="1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 15px;">
            ...
            <div class="modal-body">
               <form class="form add_form" method="post" name="add_form" id="department"  action="<?php echo base_url('save-department')?>" enctype="multipart/form-data" > 
